...
const handleAddToCart = () => {
  //Take all the informations and send to reducer
  dispatch({
    type: 'ADD_PRODUCT',
    payload:{data, qt}
  });
    ...
    <Container>
      <ProductArea>
        ...
        <ProductInfoArea>
          ...
          <ProductQuantityArea>
            <ProductQuantity>
              <ProductQtImage onClick={handleMinusQt} src='/assets/Devsfood_img/minus.png' />
              <ProductQtText>{qt}</ProductQtText>
              <ProductQtImage onClick={handlePlusQt} src='/assets/Devsfood_img/plus.png' />
            </ProductQuantity>
            <ProductPrice>
